...
{/*  Content  */}
<CardTitle className="text-3xl font-bold text-white mb-2">Hello, Child!</CardTitle>
<CardDescription className="text-sm text-zinc-400 max-w-[280px]">Share this code with your parent to continue</CardDescription>
</CardHeader>
